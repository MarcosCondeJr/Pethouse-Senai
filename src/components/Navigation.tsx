      ...
      <div className="container mx-auto px-4 py-3">
        ...
        <div className="flex items-center">
          ...
          <div className="md:hidden flex items-center">
            <button className="text-gray-700 hover:text-accent transition-colors" onClick={() => setIsMenuOpen(!isMenuOpen)} aria-label={isMenuOpen ? "Fechar menu" : "Abrir menu"}>
...
const MobileNavLink = ({
  ...
  return <Link to={to} className={`block px-3 py-2 rounded-md ${isActive ? 'bg-gradient-to-r from-primary-50 to-accent-50 text-accent font-medium border-l-4 border-accent' : 'hover:bg-gray-50'}`} onClick={onClick}>
      {children}
    </Link>;
};