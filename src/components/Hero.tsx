          ...
          <div className="relative h-80 md:h-auto flex justify-center">
            <div className="relative w-full max-w-md">
              ...
              <img
                ...
                alt="Gato fofo"
                className="relative z-10 w-full h-auto object-cover rounded-3xl shadow-lg animate-bounce-slow border-4 border-white"
              />
            </div>
          </div>
        </div>
...
const StatCard = ({ number, text, color }: StatCardProps) => {
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg p-6 flex flex-col items-center text-center card-hover border-t-4 border-t-accent">
